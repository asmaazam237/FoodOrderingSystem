  ...
  public static Cart getInstance() {
    ...
    private void paybtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_paybtnActionPerformed
        ...
        if (!rs.isBeforeFirst()) {  // Checks if there are any rows
            JOptionPane.showMessageDialog(null, "Your cart is empty. Please add items before proceeding to payment.");
        ...
        // Only show the payment page if the cart was not empty and insert was successful
    ...
    public void setVisible(boolean visible) {
        ...
        foodItemsTable.setDefaultEditor(Object.class, null); // disables editing
    }
